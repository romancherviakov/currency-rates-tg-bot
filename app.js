...
const monobank = require("./services/currencyProviders/monobank")(axios, logger);
...
const currencyService = require("./services/currencyService")(monobank, privat, privatCard, ukrsib, nbu);
